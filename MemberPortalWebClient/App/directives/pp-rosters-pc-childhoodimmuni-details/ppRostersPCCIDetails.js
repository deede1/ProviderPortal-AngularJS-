(function () {
    ...
    app.directive("rosterPccidDetails",  function ( ) {
        return {
            scope: true,
        restrict: "EA",
        //replace: true, 
        templateUrl: urlBase + '/App/directives/pp-rosters-pc-childhoodimmuni-details/ppRostersPCCIDetails.html' + cacheBust,
        controller: 'pPRostersPCCIDetailsController'  
        };
    });
 
    //============= CONTROLLER
    app.controller('pPRostersPCCIDetailsController',
    [
        ...
        function ($scope, $rootScope, $attrs, $element, $compile, memberDataService) {
            ...
            $scope.$on('updateDetails', function (event, dataObject) {
                console.log('@ PCCID DETAILS UPDATE DETAILS for MEMBER:' + dataObject.subscriberNumber);
